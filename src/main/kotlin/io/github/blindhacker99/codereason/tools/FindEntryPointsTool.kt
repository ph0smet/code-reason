...
import io.github.blindhacker99.codereason.analysis.EntryPointFinder
...
data class EntryPointsResult(
    ...
    val entryPoints: List<io.github.blindhacker99.codereason.analysis.EntryPoint>,
)

fun Server.addFindEntryPointsTool() {
    addTool<FindEntryPointsPayload>(
        name = "reason_find_entry_points",
        description =
            "Identify HTTP handlers, API endpoints, CLI entry points, and other attack surface " +
                ...
                "Requires reason_analyze_project to be called first.",
    ) { payload ->
